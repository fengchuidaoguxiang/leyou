...
public class SearchService {
    ...
    private QueryBuilder buildBasicQuery(SearchRequest request) {
        // 创建布尔查询
        BoolQueryBuilder querBuilder = QueryBuilders.boolQuery();
        // 查询条件
        querBuilder.must(QueryBuilders.matchQuery("all",request.getKey()));
        // 过滤条件
        ...
        for (Map.Entry<String, String> entry : map.entrySet()) {
            ...
            querBuilder.filter(QueryBuilders.termQuery(key,entry.getValue()));
        }
        return querBuilder;
    }
