...
import com.leyou.user.mapper.SkuMapper;
import com.leyou.user.mapper.SpuDetailMapper;
import com.leyou.user.mapper.SpuMapper;
import com.leyou.user.mapper.StockMapper;
...
public class GoodsService {
    ...
    public List<Sku> querySkuBySpuId(Long spuId) {
        ...
        if(CollectionUtils.isEmpty(skuList)){
            throw new LyException(ExceptionEnum.SPEC_SKU_NOT_FOUND);
        }
    ...
    @Transactional
    public synchronized void decreaseStock(List<CartDTO> carts) {
